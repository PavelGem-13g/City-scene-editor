...
public class CameraFly : MonoBehaviour
{
    ...
    void Update()
    {
        try
        {
            ...
            rotationX += UltimateJoystick.GetHorizontalAxis( "Turn" ) * DifferentThings.mouseSensitivity;
            rotationY += UltimateJoystick.GetVerticalAxis("Turn") * DifferentThings.mouseSensitivity;
            ...
            // перемещение камеры
            transfer = transform.forward * UltimateJoystick.GetVerticalAxis( "Move" );
            transfer += transform.right * UltimateJoystick.GetHorizontalAxis("Move");
